...
class AServerlessHandler {
    ...
    handler(options) {
        let routes = ``;
        core_1.RouteMetadata.register(core_1.RouteInternalController.prototype, 'getUris', 'GET', '/sd');
        core_1.RouteMetadata.registerController(core_1.RouteInternalController, '');
