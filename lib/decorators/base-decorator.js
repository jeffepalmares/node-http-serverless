...
class BaseDecorator {
    static defaultHandleError(err) {
        ...
        if (err instanceof node_http_helper_1.HttpGenericError) {
            return new dtos_1.HttpResponse(err.statusCode, err.message, (_a = err['originData']) !== null && _a !== void 0 ? _a : err.data);
        }
        return new dtos_1.HttpResponse((_b = err['statusCode']) !== null && _b !== void 0 ? _b : node_http_helper_1.HttpStatusCode.INTERNAL_SERVER_ERROR, null, err);
    }
