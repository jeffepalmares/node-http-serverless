...
class BaseHttpMethodDecorator extends base_decorator_1.BaseDecorator {
    ...
    static request(target, propertyKey, propDesc, method, route) {
        ...
        propDesc.value = function (rawRequest) {
            ...
            return BaseHttpMethodDecorator.applyOriginal(this, originalFunction, args, BaseHttpMethodDecorator.handleSuccess, BaseHttpMethodDecorator.handleError);
        };
        return propDesc;
    }
